...
router.post(
  ...
  isLoggedIn,
  isMatchingUser({ err: 'not allowed to create comment' }),
...
router.post(
  ...
  isLoggedIn,
  isMatchingUser({ err: 'not allowed to like comment' }),
...
router.put(
  ...
  isLoggedIn,
  isMatchingUser({ err: 'not allowed to edit comment' }),
...
router.delete(
  ...
  isLoggedIn,
  isMatchingUser({ err: 'not allowed to delete comment' }),
